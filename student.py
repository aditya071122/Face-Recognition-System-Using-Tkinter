...
class Student:
    def __init__(self,root):
        ...
        #first
        img = Image.open(r"C:\Users\Aditya\Desktop\projects\Face recogination system\\college_images\download student.jpg")
        ...
        #second
        img2 = Image.open(r"C:\Users\Aditya\Desktop\projects\Face recogination system\\college_images\download student 1.jpg")
        ...
        #thir
        img3 = Image.open(r"C:\Users\Aditya\Desktop\projects\Face recogination system\\college_images\images student 2.jpg")
        ...
        #background
        img4 = Image.open(r"C:\Users\Aditya\Desktop\projects\Face recogination system\\college_images\360_F_287071353_WXFljgcyA6kHEniBIKCyqRYaviBZTS4p.jpg")
        ...
        img5 = Image.open(r"C:\Users\Aditya\Desktop\projects\Face recogination system\\college_images\shutterstock_1191637648-1.png")
        img5 = img5.resize((720,130) )
        ...
        #student_id
        studentId_label=Label(class_student_frame,  text="StudentId:", font=("times new roman", 13, "bold"), fg="black",bg="white")
        studentId_label.grid(row=0,column=0, padx=10, sticky=W)
        studentId_entry=ttk.Entry(class_student_frame,textvariable=self.var_std_id,width=20,font=("times new roman", 13, "bold"))
        studentId_entry.grid(row=0,column=1,padx=10, sticky=W)
        #student name
        studentName_label=Label(class_student_frame, text="Student Name:", font=("times new roman", 13, "bold"),fg="black",bg="white")
        ...
        #class division
        class_div_label=Label(class_student_frame, text="Class Division:", font=("times new roman", 13, "bold"),fg="black",bg="white")
        ...
        #roll no.
        roll_no_label=Label(class_student_frame, text="Roll No:", font=("times new roman", 13, "bold"),fg="black",bg="white") 
        roll_no_label.grid(row=1,column=2,padx=10, pady=5, sticky=W)
        roll_no_entry=ttk.Entry(class_student_frame,textvariable=self.var_roll,width=20,font=("times new roman", 13, "bold"))
        roll_no_entry.grid(row=1,column=3,padx=10,pady=5, sticky=W)
        #Gender
        Gender_label=Label(class_student_frame, text="Gender:", font=("times new roman", 13, "bold"),fg="black",bg="white") 
        ...
        #DOB
        DOB_label=Label(class_student_frame, text="DOB:", font=("times new roman", 13, "bold"),fg="black",bg="white") 
        DOB_label.grid(row=2,column=2,padx=10, pady=5, sticky=W)
        DOB_entry=ttk.Entry(class_student_frame,textvariable=self.var_dob,width=20,font=("times new roman", 13, "bold"))
        DOB_entry.grid(row=2,column=3,padx=10,pady=5, sticky=W)
        #Email
        Email_label=Label(class_student_frame, text="Email:", font=("times new roman", 13, "bold"),fg="black",bg="white") 
        Email_label.grid(row=3,column=0,padx=10, pady=5, sticky=W)
        Email_entry=ttk.Entry(class_student_frame,textvariable=self.var_email,width=20,font=("times new roman", 13, "bold"))
        Email_entry.grid(row=3,column=1,padx=10,pady=5, sticky=W)
        #phone_no
        phone_no_label=Label(class_student_frame, text="phone no:", font=("times new roman", 13, "bold"),fg="black",bg="white") 
        ...
        #Address
        Address_label=Label(class_student_frame, text="Address:", font=("times new roman", 13, "bold"),fg="black",bg="white") 
        Address_label.grid(row=4,column=0,padx=10, pady=5, sticky=W)
        Address_entry=ttk.Entry(class_student_frame,textvariable=self.var_address,width=20,font=("times new roman", 13, "bold"))
        Address_entry.grid(row=4,column=1,padx=10,pady=5, sticky=W)
        #Teacher_name
        Teacher_name_label=Label(class_student_frame, text="Teacher name:", font=("times new roman", 13, "bold"),fg="black",bg="white") 
        ...
        Take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take a photo",width=35, font=("times new roman", 13, "bold"),bg="blue",fg="white")
        Take_photo_btn.grid(row=0,column=0)

        update_photo_btn=Button(btn_frame1,text="Update a photo",width=35, font=("times new roman", 13, "bold"),bg="blue",fg="white")
        ...
        img_right = Image.open(r"C:\Users\Aditya\Desktop\projects\Face recogination system\\college_images\istockphoto-1438437093-612x612.jpg")
        ...
        searchby_label=Label(search_frame, text="search:", font=("times new roman", 13, "bold"),bg="red",fg="white") 
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                if Update>0:
                    conn=mysql.connector.connect(host='localhost',user='root',password='Anonymous@1510',database='face_recognizer')
                    my_cursor=conn.cursor()
                    my_cursor.execute(("update student set dep=%s,course=%s,year=%s,semester=%s,name=%s,division=%s,studentroll=%s,gender=%s,dob=%s,email=%s,phone=%s,address=%s,teacher=%s,photosample=%s where student_id=%s"),(                              (
                                                                                                                self.var_dep.get(),
                                                                                                                self.var_course.get(),
                                                                                                                self.var_year.get(),
                                                                                                                self.var_semester.get(),

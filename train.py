...
class Train:
    def __init__(self,root):
        ...
        title_lbl = Label(self.root,text="TRAIN DATA SET",font=("times new roman",35,"bold"),bg="red",fg="black")
        title_lbl.place(x=0,y=0,width=1530,height=45)

        img_top = Image.open(r"C:\Users\Aditya\Desktop\projects\Face recogination system\\college_images\\download student 1.jpg")
        ...
        img_bottom = Image.open(r"C:\Users\Aditya\Desktop\projects\Face recogination system\\college_images\face-biometric-database-1024x418.jpeg")

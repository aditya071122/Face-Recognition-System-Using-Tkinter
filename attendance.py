...
class Attendance:
    def __init__(self,root):
        ...
        #first
        img = Image.open(r"college_images\download student.jpg")
        ...
        #second
        img2 = Image.open(r"college_images\download student 1.jpg")
        ...
        title_lbl = Label(bg_image,text="ATTENDANCE MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="White",fg="darkgreen")
        ...
        img5 = Image.open(r"college_images\shutterstock_1191637648-1.png")
        ...
        #Labels and entries
        #Attendance id
        attendanceId_label=Label(left_inside_frame,  text="AttendanceId:", font=("times new roman", 13, "bold"), fg="black",bg="white")
        ...
        #roll
        rollLabel=Label(left_inside_frame,  text="Roll:", font=("times new roman", 13, "bold"), fg="black",bg="white")
        ...
        #name
        nameLabel=Label(left_inside_frame,  text="Name:", font=("times new roman", 13, "bold"), fg="black",bg="white")
        ...
        #department
        depLabel=Label(left_inside_frame,  text="Department:", font=("times new roman", 13, "bold"), fg="black",bg="white")
        ...
        #time
        timeLabel=Label(left_inside_frame,  text="Time:", font=("times new roman", 13, "bold"), fg="black",bg="white")
        ...
        #date
        dateLabel=Label(left_inside_frame,  text="Date:", font=("times new roman", 13, "bold"), fg="black",bg="white")
        ...
        #attendance
        attendanceLabel=Label(left_inside_frame,  text="Attendance Status:", font=("times new roman", 13, "bold"), fg="black",bg="white")
        attendanceLabel.grid(row=3,column=0, padx=4,pady=8)
        self.atten_status=ttk.Combobox(left_inside_frame,textvariable=self.var_atten_attendance ,width=20, font=("times new roman", 13, "bold"),state="readonly")
